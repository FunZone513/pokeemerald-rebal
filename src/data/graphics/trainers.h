...
const u8 gTrainerBackPic_Nidoqueen[] = INCBIN_U8("graphics/trainers/back_pics/nidoqueen.4bpp");
const u32 gTrainerPalette_Nidoqueen[] = INCBIN_U32("graphics/trainers/back_pics/nidoqueen.gbapal.lz");
...
const struct SpriteFrameImage gTrainerBackPicTable_Nidoqueen[] =
{
    {gTrainerBackPic_Nidoqueen + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Nidoqueen + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Nidoqueen + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Nidoqueen + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_NIDOQUEEN, 4, gTrainerBackPic_Nidoqueen, gTrainerBackPicTable_Nidoqueen, gTrainerPalette_Nidoqueen, sBackAnims_Hoenn),
};
